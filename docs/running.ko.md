...
아래 세 가지 시나리오 유형은 스킬 자체의 종단간 eval([`../loop-optimizer/evals/evals.json`](../loop-optimizer/evals/evals.json))과
대응됩니다.
...
[`../loop-optimizer/agents/bootstrapper.md`](../loop-optimizer/agents/bootstrapper.md)를 보세요.
